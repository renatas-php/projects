                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>  @foreach($sliders as $slider)
                                            <tr>
                                                <td>{{ $slider->title }}</td>
                                                ...
                                                <td> <img src="{{  asset("storage/$slider->slider")  }}" width="100px" heigh="100px"></td>
                                                ...
                                                <td>
                                                <a href="{{ route('sliders.edit', $slider->id) }}" class="btn btn-primary btn-sm">Redaguoti</a>
