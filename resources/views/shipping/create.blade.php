                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('shippings.index') }}" class="breadcrumb-link">Pristatymo būdai</a></li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="name" name="name" value="{{ isset($shipping) ? $shipping->name : '' }}" type="text" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            <label for="price" class="col-form-label">Kaina</label>
                                            <input id="price" type="text" value="{{ isset($shipping) ? $shipping->price : '' }}"name="price" class="form-control">
                                            </div>
