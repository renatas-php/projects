                    ...
                    <div class="row">
                       ...
                       @endif
                            <div class="card">
                                ...
                                <a href="{{ route('shippings.create') }}" class="btn btn-success btn-sm float-right">+ Sukurti pristatymo metodą</a>
                                </div>
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>   @foreach($shippings as $shipping)
                                            <tr>
                                                ...
                                                <td>
                                                <a href="{{  route('shippings.edit', $shipping->id) }}" class="btn btn-primary btn-sm">Redaguoti</a>
