                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('products.index') }}" class="breadcrumb-link">Visi produktai</a></li>
                    ...
                    <div class="row">
                       ...
                       @endif
                            <div class="card">
                                ...
                                <a href="{{  route('products.create')  }}" class="btn btn-success btn-sm float-right">+ Pridėti produktą</a>
                                <a href="{{  route('products.index')  }}" class="btn btn-primary btn-sm mr-2 float-right">Atgal</a>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>  @foreach($products as $product)
                                            <tr>
                                                ...
                                                <td><a class="text-dark" href="{{ route('categories.showById', $product->category->id) }}"> {{  $product->category->name  }} </a></td>
                                                <td>  {{ $product->price }}  </td>
                                                ...
                                                <td>
                                                <a href="{{  route('products.edit', $product->id)  }}" class="btn btn-primary btn-sm">Redaguoti</a>
