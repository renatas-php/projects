                    ...
                    <div class="row">
                       ...
                       @endif
                            <div class="card">
                                ...
                                <a href="{{ route('categories.create') }}" class="btn btn-success btn-sm float-right">+ Pridėti kategoriją</a>
                                </div>
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>  
                                            <tr>
                                                ...
                                                <button  class="btn btn-danger btn-sm" onclick="handleDelete({{ $category->id }})">Ištrinti</button>
                                                </td>
                                                </tr>  @endforeach  
                                        </tbody>
                                    </table>
