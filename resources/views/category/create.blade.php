                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('categories.index')}}" class="breadcrumb-link">Kategorijos</a></li>
                    ...
                    <div class="row">
                        ...
                        <!-- ============================================================== -->
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">{{ isset($category) ? 'Redaguoti kategoriją' : 'Pridėti kategoriją'  }}</h5>
                                    <div class="card-body">
                                        ...
                                        @endif
                                            <div class="form-group">
                                                ...
                                                <input id="name" name="name" value="{{ isset($category) ? $category->name : ''   }}" type="text" class="form-control">
                                            </div>
