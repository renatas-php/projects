                ...
                <div class="col-lg-6">
                    <div class="product-content">
                        ...
                        <div class="pc-meta">
                            ...
                            <li><span>Vardas :</span> {{ auth()->user()->name }}</li>
                            <li><span>Pavarde :</span> {{ auth()->user()->surname}}</li>
                            <li><span>Adresas :</span> {{ auth()->user()->adress }}</li>
                            <li><span>Miestas :</span> {{ auth()->user()->city }}</li>
                            <li><span>Tel.nr. :</span> {{ auth()->user()->phone }}</li>
                            <li><span>El. pastas :</span> {{ auth()->user()->email }}</li>
                            @endauth
                        </ul>
                        ...
                        <ul class="tags">
                           ...
                           <li><span>Užsakymo data : </span> <a href="{{ route('user.orders', $order->id) }}"> {{ $order->created_at }}</a></li>
