                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Kategorijos</h2>
                            <p class="pageheader-text"></p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>" class="breadcrumb-link">Pagrindinis</a></li>
                                        <li class="breadcrumb-item"><a href="<?php echo e(route('categories.index')); ?>" class="breadcrumb-link">Kategorijos</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Pridėti kategoriją</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <!-- ============================================================== -->
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header"><?php echo e(isset($category) ? 'Redaguoti kategoriją' : 'Pridėti kategoriją'); ?></h5>
                                    <div class="card-body">
                                        ...
                                        <?php endif; ?>
                                            <div class="form-group">
                                                <label for="name" class="col-form-label">Kategorijos pavadinimas</label>
                                                <input id="name" name="name" value="<?php echo e(isset($category) ? $category->name : ''); ?>" type="text" class="form-control">
                                            </div>
                                        <button type="submit" class="btn btn-success btn-sm">Isšaugoti</button>
                                        </form>
...
</html><?php /**PATH C:\Users\php\todos\blog\eshop\resources\views/category/create.blade.php ENDPATH**/ ?>