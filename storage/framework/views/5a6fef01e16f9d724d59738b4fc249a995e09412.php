        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <h2><span>.<?php echo e($category->name); ?></span></h2>
                        <a class="active" href="<?php echo e(route('/')); ?>">Pradinis</a>
                        ...
                        <div class="categories-filter">
                            <div class="cf-left">
                                ...
                                <select class="sort" name="formal" onchange="javascript:handleSelect(this)">
                                        ...
                                        <option value="?sort=low_high"><a href="<?php echo e(route('front.category', ['category' => request()->category, 'sort' => 'low_high'])); ?>">Kaina didėjimo tvarka</a></option>
                                        <option value="?sort=high_low"> <a href="<?php echo e(route('front.category', ['category' => request()->category, 'sort' => 'high_low'])); ?>">Kaina mažėjimo tvarka</a></option>
            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-3 col-md-6">
                    <div class="single-product-item">
                       <figure>
                        <a href="<?php echo e(route('product.show', $product->id)); ?>" ><img src="<?php echo e(asset("storage/$product->image")); ?>" alt=""></a>                                                               
                        ...
                        <div class="product-text">
                            ...
                            <p><?php echo e($product->price); ?> EUR</p>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH C:\Users\php\todos\blog\eshop\resources\views/front/category.blade.php ENDPATH**/ ?>