                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Pristatymo būdo pridėjimas</h2>
                            <p class="pageheader-text"></p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>" class="breadcrumb-link">Pagrindinis</a></li>
                                        <li class="breadcrumb-item"><a href="<?php echo e(route('shippings.index')); ?>" class="breadcrumb-link">Pristatymo būdai</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Pristatymo būdo pridėjimas</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <!-- ============================================================== -->
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">Pridėti pristataymo būdą</h5>
                                    <div class="card-body">
                                    
                                        <form action="<?php echo e(route('shippings.store')); ?>" method="POST">
                                                                                                        
                                        <?php echo csrf_field(); ?>
                                        
                                        
                                            <div class="form-group">
                                                <label for="name" class="col-form-label">Pristatymo pavadinimas</label>
                                                <input id="name" name="name" value="<?php echo e(isset($shipping) ? $shipping->name : ''); ?>" type="text" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            <label for="price" class="col-form-label">Kaina</label>
                                            <input id="price" type="text" value="<?php echo e(isset($shipping) ? $shipping->price : ''); ?>"name="price" class="form-control">
                                            </div>
...
</html><?php /**PATH C:\Users\php\todos\blog\eshop\resources\views/shipping/create.blade.php ENDPATH**/ ?>