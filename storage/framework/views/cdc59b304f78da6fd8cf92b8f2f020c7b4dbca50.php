            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Visi vartotojai</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Visi vartotojai</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                       ...
                       <?php endif; ?>
                            <div class="card">
                                <div class="card-header">Vartotojai
                                ...
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>  <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="" class="btn btn-primary btn-sm">Redaguoti</a>
...
</html><?php /**PATH C:\Users\php\todos\blog\eshop\resources\views/user/index.blade.php ENDPATH**/ ?>