            ...
            <div class="container-fluid  dashboard-content">
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                       ...
                       <?php endif; ?>
                            <div class="card">
                                <div class="card-header">Kategorijos
                                <a href="<?php echo e(route('categories.create')); ?>" class="btn btn-success btn-sm float-right">+ Pridėti kategoriją</a>
                                </div>
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>  
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?php echo e(route('categories.edit', $category->id)); ?>" class="btn btn-primary btn-sm">Redaguoti</a>
                                                <button  class="btn btn-danger btn-sm" onclick="handleDelete(<?php echo e($category->id); ?>)">Ištrinti</button>
                                                </td>
            ...
            <div class="footer">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        Testinė el. parduotuvė sukurta nuo nulio su Laravel. <a href="https://colorlib.com/wp/">Colorlib</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
...
</html><?php /**PATH C:\Users\php\todos\blog\eshop\resources\views/category/index.blade.php ENDPATH**/ ?>