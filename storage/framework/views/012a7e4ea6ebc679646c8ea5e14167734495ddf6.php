            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Visos skaidrės</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Visos skaidrės</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                       ...
                       <?php endif; ?>
                            <div class="card">
                                <div class="card-header">Skaidrės informacija
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col">Sekantis pavadinimas</th>
                                        ...
                                        <tbody>  <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($slider->title); ?></td>
                                                
                                                <td><?php echo e($slider->title1); ?></td>
                                             
                                               
                                             
                                                <td> <?php echo e($slider->link); ?> </td>
                                             
                                                <td> <img src="<?php echo e(asset("storage/$slider->slider")); ?>" width="100px" heigh="100px"></td>
                                                ...
                                                <td>
                                                <a href="<?php echo e(route('sliders.edit', $slider->id)); ?>" class="btn btn-primary btn-sm">Redaguoti</a>
...
</html><?php /**PATH C:\Users\php\todos\blog\eshop\resources\views/slider/index.blade.php ENDPATH**/ ?>