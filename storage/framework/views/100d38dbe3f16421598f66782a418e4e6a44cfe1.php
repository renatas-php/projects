            ...
            <div class="container-fluid  dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Meniu info juosta</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                       ...
                       <?php endif; ?>
                            <div class="card">
                                <div class="card-header">Meniu info juosta
                                ...
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>  <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td> <img src="<?php echo e(asset("storage/$banner->icon")); ?>" width="50px" heigh="50px"></td>
                                                ...
                                                <td>
                                                <a href="<?php echo e(route('banners.edit', $banner->id)); ?>" class="btn btn-primary btn-sm">Redaguoti</a>
...
</html><?php /**PATH C:\Users\php\todos\blog\eshop\resources\views/extra/banner.blade.php ENDPATH**/ ?>