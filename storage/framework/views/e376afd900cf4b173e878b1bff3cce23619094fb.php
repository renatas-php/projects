            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Pristatymo būdai </h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Pristatymo būdai</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                       ...
                       <?php endif; ?>
                            <div class="card">
                                <div class="card-header">Pristatymo būdai
                                <a href="<?php echo e(route('shippings.create')); ?>" class="btn btn-success btn-sm float-right">+ Sukurti pristatymo metodą</a>
                                </div>
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>   <?php $__currentLoopData = $shippings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipping): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($shipping->price); ?> Eur</td>
                                                ...
                                                <td>
                                                <a href="<?php echo e(route('shippings.edit', $shipping->id)); ?>" class="btn btn-primary btn-sm">Redaguoti</a>
...
</html><?php /**PATH C:\Users\php\todos\blog\eshop\resources\views/shipping/index.blade.php ENDPATH**/ ?>